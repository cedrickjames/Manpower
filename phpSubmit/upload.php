...
if($destinationPath==''){
  $sqlinsertLine = "INSERT INTO `line`(`line_name`, `line_desc`, `line_location`,`Department`, `last_time_updated`) VALUES ('$line_name','$machine_desc','$machine_loc','$Department','$LTUpdated');";
