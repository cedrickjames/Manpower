...
if (isset($_POST['uploadBtn']) && $_POST['uploadBtn'] == 'Upload')
{
  ...
  $sqlinsertLine = "INSERT INTO `line`(`line_name`, `line_desc`, `line_location`,`Department`, `last_time_updated`, `line_photo`) VALUES ('$line_name','$machine_desc','$machine_loc','Production2','$LTUpdated','$destinationPath');";
