...
$sqlinsertModel= "INSERT INTO `model`(`model_name`, `model_line`, `id_model_line`, `japan_stu`, `gpi_stu`, `actual_time`,`Department`) VALUES ('$modal_name','$modal_line_name ','$lineId','$InputJPNSTU','$InputGPISTU','$InputActualTime','Production2')";
