...
for($i=12; $i>=1; $i--){
  ...
  $selectTotal = "SELECT SUM(`forecast_actual`) as 'TOTAL' FROM `forecast` WHERE `year` = '$year' and `month`='$monthName' AND `Department` = 'Production2';";
  ...
  $selectTotalGPi = "SELECT SUM(`mp_forecast_gpi_target`) as 'TOTAL' FROM `forecast` WHERE `year` = '$year' and `month`='$monthName' AND `Department` = 'Production2';";
  ...
  $selectTotalActMan = "SELECT SUM(`actual_manpower`) as 'TOTAL' FROM `forecast` WHERE `year` = '$year' and `month`='$monthName' AND `Department` = 'Production2';";
  ...
  $selectTotalMan = "SELECT SUM(`total_manpower_needed`) as 'TOTAL' FROM `forecast` WHERE `year` = '$year' and `month`='$monthName' AND `Department` = 'Production2';";
