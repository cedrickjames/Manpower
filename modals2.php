...
<!-- Modal -->
<form action="../Prod2Submit/deleteForecast.php" method="POST">
...
<div class="modal fade" id="editForecast" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form class="row g-3 computer" action="../Prod2Submit/editForecast.php" method="POST">
      ...
      <div class="modal-body">
        <div class="row row-cols-1 row-cols-md-2 g-2 ">
          ...
          <div class="col col-form">
            ...
            <form method="POST" action="../Prod2Submit/upload.php" enctype="multipart/form-data" class="mt-3">
      ...
      <div class="modal-body">
        <div class="row row-cols-1 row-cols-md-1 g-1 ">
          ...
          <div class="col col-form">
            ...
            <form method="POST" action="../Prod2Submit/addModel.php" enctype="multipart/form-data" class="m-3">
...
if($location == "list_of_models"){
 ...
 ?>" method="POST">
            ...
            <form method="POST" action="../Prod2Submit/addWorkingDays.php" name="workingDays"
      ...
      <div class="modal-body">
        <div class="row row-cols-1 row-cols-md-1 g-1 ">
          ...
          <div class="col col-form">
            ...
            <form method="POST" action="../Prod2Submit/addEmployee.php" enctype="multipart/form-data" class="m-3">
              <!-- <input type="text" id="containerOfLineId" name="containerOfLineId" style="display: none"> -->
              <div class="form-floating mb-3">
